...
MESSAGES: dict[str, str] = {
    ...
    "admin.update.downtime": "Le service web et le worker redémarrent avec la nouvelle image ; prévois une courte interruption et recharge la page ensuite.",
    "admin.update.manual": "Les mises à jour automatiques ne sont pas configurées (COS_WEB_ADMIN_UPDATE_DIR). Récupère la nouvelle image et recrée les conteneurs.",
    "admin.update.pending": "Une mise à jour a été demandée et l'updater ne l'a pas encore prise en charge.",
    "admin.update.last": "Dernière exécution de l'updater : {state} ({version}).",
    "admin.update.outcome.requested": "Mise à jour demandée. Le service redémarre dans un instant.",
    ...
    "admin.update.outcome.pending": "Une mise à jour attend déjà l'updater.",
    "admin.update.outcome.failed": "La demande n'a pas pu être écrite. Rien n'a changé.",
