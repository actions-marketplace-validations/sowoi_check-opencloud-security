...
MESSAGES: dict[str, str] = {
    ...
    "admin.update.downtime": "The web service and the worker are restarted with the new image; expect a short downtime and reload the page afterwards.",
    "admin.update.manual": "Automatic updates are not set up (COS_WEB_ADMIN_UPDATE_DIR). Pull the new image and recreate the containers to update.",
    "admin.update.pending": "An update has been requested and the updater has not picked it up yet.",
    "admin.update.last": "Last updater run: {state} ({version}).",
    "admin.update.outcome.requested": "Update requested. The service restarts in a moment.",
    ...
    "admin.update.outcome.pending": "An update is already waiting for the updater.",
    "admin.update.outcome.failed": "The request could not be written. Nothing changed.",
