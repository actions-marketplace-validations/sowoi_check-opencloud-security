...
MESSAGES: dict[str, str] = {
    ...
    "compare.newly_measured.heading": "Checked for the first time ({count})",
    "compare.newly_measured.note": "The earlier scan did not make these checks, so they were not passing then either. They fail now, but that says nothing about the instance having changed.",
    "compare.no_longer_measured.heading": "No longer checked ({count})",
    "compare.no_longer_measured.note": "These failed in the earlier scan, and the later scan did not make these checks. That does not mean they were fixed.",
