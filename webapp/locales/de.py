...
MESSAGES: dict[str, str] = {
    ...
    "admin.update.downtime": "Webdienst und Worker werden mit dem neuen Image neu gestartet; rechne mit einer kurzen Ausfallzeit und lade die Seite danach neu.",
    "admin.update.manual": "Automatische Updates sind nicht eingerichtet (COS_WEB_ADMIN_UPDATE_DIR). Zieh das neue Image und erstelle die Container neu.",
    "admin.update.pending": "Ein Update wurde angefordert, der Updater hat es noch nicht übernommen.",
    "admin.update.last": "Letzter Updater-Lauf: {state} ({version}).",
    "admin.update.outcome.requested": "Update angefordert. Der Dienst startet gleich neu.",
    ...
    "admin.update.outcome.pending": "Ein Update wartet bereits auf den Updater.",
    "admin.update.outcome.failed": "Die Anforderung ließ sich nicht schreiben. Nichts wurde geändert.",
