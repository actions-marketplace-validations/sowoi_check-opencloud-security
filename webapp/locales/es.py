...
MESSAGES: dict[str, str] = {
    ...
    "admin.update.downtime": "El servicio web y el worker se reinician con la nueva imagen; habrá una breve interrupción, recargue la página después.",
    "admin.update.manual": "Las actualizaciones automáticas no están configuradas (COS_WEB_ADMIN_UPDATE_DIR). Descargue la nueva imagen y vuelva a crear los contenedores.",
    "admin.update.pending": "Se ha solicitado una actualización y el updater aún no la ha recogido.",
    "admin.update.last": "Última ejecución del updater: {state} ({version}).",
    "admin.update.outcome.requested": "Actualización solicitada. El servicio se reinicia en un momento.",
    ...
    "admin.update.outcome.pending": "Ya hay una actualización esperando al updater.",
    "admin.update.outcome.failed": "No se pudo escribir la solicitud. No ha cambiado nada.",
