...
| [`golden_corpus.py`](golden_corpus.py) | The golden corpus's instances, its pinned release schedule and advisory database, and what a verdict remembers. Regenerated by `scripts/update_golden_corpus.py`. |
