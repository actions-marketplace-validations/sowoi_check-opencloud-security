...
| `tlsDnssec`                                                                                                                                | low           | La zona que responde por este nombre no está firmada, así que no se puede detectar una dirección falsificada; ausente, nunca fallida, cuando el resolvedor usado no admite DNSSEC |
