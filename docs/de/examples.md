...
## Release-Kanal wählen {#release-track-examples}
...
Eine neuere Version ist nicht automatisch länger unterstützt. Läuft auf einem als `production` deklarierten System ein neueres Rolling-Release, meldet der Scanner es als dem Kanal voraus. Es gilt weder als aktuelles Production-Release noch allein deshalb als End of Life. Letzteres betrifft eine hinter dem Kanal zurückliegende Version.

## Befunde bewusst ausnehmen {#accepting-findings-you-are-not-going-to-fix}
...
Dieselben Einstellungen als Umgebungsvariablen für Container oder systemd:
...
## Private Instanzen {#instances-that-are-not-on-the-public-internet}
...
## Schwellwerte und Benachrichtigungen {#thresholds-and-notifications}
...
## Icinga2-CheckCommand {#icinga2-command-definition}
...
## Den Scanner direkt verwenden {#the-scanner-on-its-own}
