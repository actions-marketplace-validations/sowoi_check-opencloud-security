# Ansible pour les hôtes Icinga2

Les playbooks dans [`ansible/`](../../ansible/README.md) installent et configurent le plugin sur
un ou plusieurs hôtes Icinga2, avec une installation native ou Docker. Ils
