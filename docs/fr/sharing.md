...
Pour un lien de partage public, la possession de l'URL peut être suffisante pour accéder à son contenu. Les
scanner lit les capacités d'OpenCloud-S pour vérifier si les liens nécessitent des mots de passe et
si l'expiration automatique est déclarée.
