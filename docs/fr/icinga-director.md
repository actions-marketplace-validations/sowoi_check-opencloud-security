# Icinga Director
[Icinga Director](https://www.icinga.com/docs/icinga-director/latest/) gère
`CheckCommand`, `Service Template` et `Service` objets via son interface utilisateur web
au lieu de fichiers de configuration manuscrits. Les étapes ci-dessous travaillent pour
native install ou l'image [Docker](installation.md#docker). Le directeur du programme
